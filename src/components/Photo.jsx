...
const Photo = ({ profileImageUrl }) => {
  const imgSrc = profileImageUrl || profile;
    ...
    <div className="flex flex-col items-center justify-center relative h-full">
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { delay: 2, duration: 0.4, ease: "easeIn" } }}>
        <motion.div
          ...
          <img src={imgSrc} alt="Profile" className="object-contain w-[180px] xl:w-[300px] rounded-full" />
        </motion.div>
        ...
        <motion.svg className="w-[300px] xl:w-[506px] h-[300px] xl:h-[506px]" fill="transparent" viewBox="0 0 506 506" xmlns="http://www.w3.org/2000/svg">
          <motion.circle cx="253" cy="253" r="155" stroke="#915eff" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" initial={{ strokeDasharray: "24 10 0 0" }} animate={{
